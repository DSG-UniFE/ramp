...
public enum MessageType {
    ...
    OS_ROUTING_REQUEST,
    OS_ROUTING_PULL_RESPONSE,
    OS_ROUTING_PUSH_RESPONSE,
    OS_ROUTING_ADD_ROUTE,
    OS_ROUTING_DELETE_ROUTE,
    OS_ROUTING_ACK,
    OS_ROUTING_ABORT,
    OS_ROUTING_UPDATE_PRIORITY_REQUEST,
    OS_ROUTING_PRIORITY_UPDATE,
    OS_ROUTING_UPDATE_PRIORITY_RESPONSE,
