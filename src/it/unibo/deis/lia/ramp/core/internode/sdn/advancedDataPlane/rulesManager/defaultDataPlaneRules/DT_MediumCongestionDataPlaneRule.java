...
public class DT_MediumCongestionDataPlaneRule extends AbstractDataPlaneRule implements Serializable {
    ...
    private long infoDelay = 25;
    private long videoDelay = 100;
    private long vibrationalDelay = 100;

    private long infoDropProbability = 25;
    private long videoDropProbability = 25;
    private long vibrationalDropProbability = 25;
    ...
    public void applyRuleToUnicastHeader(UnicastHeader uh) {
        ...
        System.out.println("--> DT_MediumCongestionDataPlaneRule is ON");
    }
...
//                if (randomNum != 0){
                    ...
                    up.setRetry((byte) 0);
                    System.out.println("DT_MediumCongestionDataPlaneRule: dropping " + dataType + " packet with seqNumber: " + seqNumber);
                }else if (finalDelay > 0){
//                }else if (false){
                    /*
                     * Consider delay
                     */
                    System.out.println("DT_MediumCongestionDataPlaneRule: delaying " + dataType + " packet with seqNumber: " + seqNumber);
                    try {
